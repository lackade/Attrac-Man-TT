...
if ( zoom )
{
	...
	snap = FadeArt( "snap", 240, 96, 192, 144 );
...
local main_caption = fe.add_text( "[FilterName]", 118, 316, 220, 14 );
//local main_caption = fe.add_text( "[DisplayName]: [FilterName]", 118, 316, 220, 14 );
